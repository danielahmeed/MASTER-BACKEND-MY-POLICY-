#!/usr/bin/env python3
"""Convert INGESTION_SERVICE_IMPLEMENTATION_SUMMARY.html to PDF.
   Run: python html_to_pdf_impl.py
   Requires: pip install xhtml2pdf"""
import os
import re

html_path = os.path.join(os.path.dirname(__file__), "INGESTION_SERVICE_IMPLEMENTATION_SUMMARY.html")
pdf_path = os.path.join(os.path.dirname(__file__), "INGESTION_SERVICE_IMPLEMENTATION_SUMMARY.pdf")
