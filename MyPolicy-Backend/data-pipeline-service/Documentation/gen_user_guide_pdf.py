#!/usr/bin/env python3
"""
Convert DATA_PIPELINE_SERVICE_USER_GUIDE.md to PDF.

Usage:
  1. Install: pip install markdown xhtml2pdf
  2. Run: python gen_user_guide_pdf.py

Output: DATA_PIPELINE_SERVICE_USER_GUIDE.pdf
"""
import os
...
MD_PATH = os.path.join(DOC_DIR, "DATA_PIPELINE_SERVICE_USER_GUIDE.md")
PDF_PATH = os.path.join(DOC_DIR, "DATA_PIPELINE_SERVICE_USER_GUIDE.pdf")
